...
def get_cookies():
        ...
        filtered_cookies = {}
        keys_to_keep = ['sp_m', 'sp_key', 'Host device_id', 'sp_dc', 'sp_gaid', 'sp_last_utm', 'sp_landing', 'sp_t', 'OptanonAlertBoxClosed', '_cs_c', '_scid', '_sctr', '_tt_enable_cookie', '_ttp', 'kdtv', '_kdt', 'RLỎ"
            if slot == True:
